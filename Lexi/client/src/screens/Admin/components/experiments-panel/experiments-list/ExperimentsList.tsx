...
const ExperimentsList = ({
    ...
    const handleMenuAction = async (action: string, row: ExperimentType) => {
        ...
        } else if (action === 'proactive-settings') {
            // Proactive settings is handled locally in ExperimentRow component
            console.log('Opening proactive settings for experiment:', row.title);
